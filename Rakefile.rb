...
task :bindings do
  sh 'find ./sdl/SDL2-2.0.3/include/ -name "*.h" | xargs -n 1 ../clang2json/build/clang2json -I ./sdl/SDL2-2.0.3/include/ | ruby ../mruby-bindings/mruby_bindings.rb -m SDL -g mruby-sdl -o ./mruby-sdl -f'
end
