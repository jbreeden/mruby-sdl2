...
mrb_SDL_SDLControllerDeviceEvent_initialize(mrb_state* mrb, mrb_value self) {
  ...
  mruby_gift_SDL_ControllerDeviceEvent_data_ptr(self, native_object);
  return self;
}
#endif
...
mrb_SDL_SDLControllerDeviceEvent_get_type(mrb_state* mrb, mrb_value self) {
  struct SDL_ControllerDeviceEvent * native_self = mruby_unbox_SDL_ControllerDeviceEvent(self);
