...
#if BIND_SDLControllerButtonEvent_type_FIELD
/* get_type
 *
 * Return Type: Uint32
 */
...
#if BIND_SDLControllerButtonEvent_timestamp_FIELD
/* get_timestamp
 *
 * Return Type: Uint32
 */
...
#if BIND_SDLControllerButtonEvent_which_FIELD
/* get_which
 *
...
#if BIND_SDLControllerButtonEvent_button_FIELD
/* get_button
 *
 * Return Type: Uint8
 */
...
#if BIND_SDLControllerButtonEvent_state_FIELD
/* get_state
 *
 * Return Type: Uint8
 */
...
#if BIND_SDLControllerButtonEvent_padding1_FIELD
/* get_padding1
 *
 * Return Type: Uint8
 */
...
#if BIND_SDLControllerButtonEvent_padding2_FIELD
/* get_padding2
 *
 * Return Type: Uint8
 */
