...
#if BIND_SDLTextInputEvent_type_FIELD
/* get_type
 *
 * Return Type: Uint32
 */
...
#if BIND_SDLTextInputEvent_timestamp_FIELD
/* get_timestamp
 *
 * Return Type: Uint32
 */
...
#if BIND_SDLTextInputEvent_windowID_FIELD
/* get_windowID
 *
 * Return Type: Uint32
 */
...
#if BIND_SDLTextInputEvent_text_FIELD
/* get_text
 *
 * Return Type: char [32]
 */
