...
#if BIND_SDLTestTestCaseReference_testCase_FIELD
/* get_testCase
 *
...
#if BIND_SDLTestTestCaseReference_name_FIELD
/* get_name
 *
 * Return Type: char *
 */
...
#if BIND_SDLTestTestCaseReference_description_FIELD
/* get_description
 *
 * Return Type: char *
 */
...
#if BIND_SDLTestTestCaseReference_enabled_FIELD
/* get_enabled
 *
 * Return Type: int
 */
...
void mrb_SDL_SDLTestTestCaseReference_init(mrb_state* mrb) {
  RClass* SDLTestTestCaseReference_class = mrb_define_class_under(mrb, SDL_module(mrb), "SDLTestTestCaseReference", mrb->object_class);
