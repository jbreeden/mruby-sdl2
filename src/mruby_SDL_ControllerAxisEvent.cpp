...
mrb_SDL_SDLControllerAxisEvent_initialize(mrb_state* mrb, mrb_value self) {
  ...
  mruby_gift_struct SDL_ControllerAxisEvent_data_ptr(self, native_object);
  return self;
}
#endif
...
#if BIND_SDLControllerAxisEvent_type_FIELD
/* get_type
 *
 * Return Type: Uint32
 */
...
mrb_SDL_SDLControllerAxisEvent_get_type(mrb_state* mrb, mrb_value self) {
  struct SDL_ControllerAxisEvent * native_self = mruby_unbox_struct SDL_ControllerAxisEvent(self);
...
#if BIND_SDLControllerAxisEvent_timestamp_FIELD
/* get_timestamp
 *
 * Return Type: Uint32
 */
...
#if BIND_SDLControllerAxisEvent_which_FIELD
/* get_which
 *
...
#if BIND_SDLControllerAxisEvent_axis_FIELD
/* get_axis
 *
 * Return Type: Uint8
 */
...
#if BIND_SDLControllerAxisEvent_padding1_FIELD
/* get_padding1
 *
 * Return Type: Uint8
 */
...
#if BIND_SDLControllerAxisEvent_padding2_FIELD
/* get_padding2
 *
 * Return Type: Uint8
 */
...
#if BIND_SDLControllerAxisEvent_padding3_FIELD
/* get_padding3
 *
 * Return Type: Uint8
 */
...
#if BIND_SDLControllerAxisEvent_value_FIELD
/* get_value
 *
 * Return Type: Sint16
 */
...
#if BIND_SDLControllerAxisEvent_padding4_FIELD
/* get_padding4
 *
 * Return Type: Uint16
 */
