...
#if BIND_SDLDropEvent_type_FIELD
/* get_type
 *
 * Return Type: Uint32
 */
...
#if BIND_SDLDropEvent_timestamp_FIELD
/* get_timestamp
 *
 * Return Type: Uint32
 */
...
#if BIND_SDLDropEvent_file_FIELD
/* get_file
 *
 * Return Type: char *
 */
...
void mrb_SDL_SDLDropEvent_init(mrb_state* mrb) {
  RClass* SDLDropEvent_class = mrb_define_class_under(mrb, SDL_module(mrb), "SDLDropEvent", mrb->object_class);
