...
mrb_SDL_SDLMouseButtonEvent_initialize(mrb_state* mrb, mrb_value self) {
  ...
  mruby_gift_SDL_MouseButtonEvent_data_ptr(self, native_object);
  return self;
}
#endif
...
#if BIND_SDLMouseButtonEvent_type_FIELD_READER
/* get_type
 *
 * Return Type: Uint32
 */
...
mrb_SDL_SDLMouseButtonEvent_get_type(mrb_state* mrb, mrb_value self) {
  struct SDL_MouseButtonEvent * native_self = mruby_unbox_SDL_MouseButtonEvent(self);
...
#if BIND_SDLMouseButtonEvent_type_FIELD_WRITER
/* set_type
 *
 * Parameters:
 * - value: Uint32
...
#if BIND_SDLMouseButtonEvent_timestamp_FIELD_READER
/* get_timestamp
 *
 * Return Type: Uint32
 */
...
#if BIND_SDLMouseButtonEvent_timestamp_FIELD_WRITER
/* set_timestamp
 *
 * Parameters:
 * - value: Uint32
...
#if BIND_SDLMouseButtonEvent_windowID_FIELD_READER
/* get_windowID
 *
 * Return Type: Uint32
 */
...
#if BIND_SDLMouseButtonEvent_windowID_FIELD_WRITER
/* set_windowID
 *
 * Parameters:
 * - value: Uint32
...
#if BIND_SDLMouseButtonEvent_which_FIELD_READER
/* get_which
 *
 * Return Type: Uint32
 */
...
#if BIND_SDLMouseButtonEvent_which_FIELD_WRITER
/* set_which
 *
 * Parameters:
 * - value: Uint32
...
#if BIND_SDLMouseButtonEvent_button_FIELD_READER
/* get_button
 *
 * Return Type: Uint8
 */
...
#if BIND_SDLMouseButtonEvent_button_FIELD_WRITER
/* set_button
 *
 * Parameters:
 * - value: Uint8
...
#if BIND_SDLMouseButtonEvent_state_FIELD_READER
/* get_state
 *
 * Return Type: Uint8
 */
...
#if BIND_SDLMouseButtonEvent_state_FIELD_WRITER
/* set_state
 *
 * Parameters:
 * - value: Uint8
...
#if BIND_SDLMouseButtonEvent_clicks_FIELD_READER
/* get_clicks
 *
 * Return Type: Uint8
 */
...
#if BIND_SDLMouseButtonEvent_clicks_FIELD_WRITER
/* set_clicks
 *
 * Parameters:
 * - value: Uint8
...
#if BIND_SDLMouseButtonEvent_padding1_FIELD_READER
/* get_padding1
 *
 * Return Type: Uint8
 */
...
#if BIND_SDLMouseButtonEvent_padding1_FIELD_WRITER
/* set_padding1
 *
 * Parameters:
 * - value: Uint8
...
#if BIND_SDLMouseButtonEvent_x_FIELD_READER
/* get_x
 *
 * Return Type: Sint32
 */
...
#if BIND_SDLMouseButtonEvent_x_FIELD_WRITER
/* set_x
 *
 * Parameters:
 * - value: Sint32
...
#if BIND_SDLMouseButtonEvent_y_FIELD_READER
/* get_y
 *
 * Return Type: Sint32
 */
...
#if BIND_SDLMouseButtonEvent_y_FIELD_WRITER
/* set_y
 *
 * Parameters:
 * - value: Sint32
...
void mrb_SDL_SDLMouseButtonEvent_init(mrb_state* mrb) {
  RClass* SDLMouseButtonEvent_class = mrb_define_class_under(mrb, SDL_module(mrb), "MouseButtonEvent", mrb->object_class);
