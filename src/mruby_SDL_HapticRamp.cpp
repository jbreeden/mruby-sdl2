...
mrb_SDL_SDLHapticRamp_initialize(mrb_state* mrb, mrb_value self) {
  ...
  mruby_gift_struct SDL_HapticRamp_data_ptr(self, native_object);
  return self;
}
#endif
...
#if BIND_SDLHapticRamp_type_FIELD
/* get_type
 *
 * Return Type: Uint16
 */
...
mrb_SDL_SDLHapticRamp_get_type(mrb_state* mrb, mrb_value self) {
  struct SDL_HapticRamp * native_self = mruby_unbox_struct SDL_HapticRamp(self);
...
#if BIND_SDLHapticRamp_direction_FIELD
/* get_direction
 *
...
#if BIND_SDLHapticRamp_length_FIELD
/* get_length
 *
 * Return Type: Uint32
 */
...
#if BIND_SDLHapticRamp_delay_FIELD
/* get_delay
 *
 * Return Type: Uint16
 */
...
#if BIND_SDLHapticRamp_button_FIELD
/* get_button
 *
 * Return Type: Uint16
 */
...
#if BIND_SDLHapticRamp_interval_FIELD
/* get_interval
 *
 * Return Type: Uint16
 */
...
#if BIND_SDLHapticRamp_start_FIELD
/* get_start
 *
 * Return Type: Sint16
 */
...
#if BIND_SDLHapticRamp_end_FIELD
/* get_end
 *
 * Return Type: Sint16
 */
...
#if BIND_SDLHapticRamp_attack_length_FIELD
/* get_attack_length
 *
 * Return Type: Uint16
 */
...
#if BIND_SDLHapticRamp_attack_level_FIELD
/* get_attack_level
 *
 * Return Type: Uint16
 */
...
#if BIND_SDLHapticRamp_fade_length_FIELD
/* get_fade_length
 *
 * Return Type: Uint16
 */
...
#if BIND_SDLHapticRamp_fade_level_FIELD
/* get_fade_level
 *
 * Return Type: Uint16
 */
