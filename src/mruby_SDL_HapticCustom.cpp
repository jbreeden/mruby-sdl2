...
mrb_SDL_SDLHapticCustom_initialize(mrb_state* mrb, mrb_value self) {
  ...
  mruby_gift_SDL_HapticCustom_data_ptr(self, native_object);
  return self;
}
#endif
...
#if BIND_SDLHapticCustom_type_FIELD_READER
/* get_type
 *
 * Return Type: Uint16
 */
...
mrb_SDL_SDLHapticCustom_get_type(mrb_state* mrb, mrb_value self) {
  struct SDL_HapticCustom * native_self = mruby_unbox_SDL_HapticCustom(self);
...
#if BIND_SDLHapticCustom_type_FIELD_WRITER
/* set_type
 *
 * Parameters:
 * - value: Uint16
...
#if BIND_SDLHapticCustom_direction_FIELD_READER
/* get_direction
 *
...
#if BIND_SDLHapticCustom_direction_FIELD_WRITER
/* set_direction
 *
 * Parameters:
...
#if BIND_SDLHapticCustom_length_FIELD_READER
/* get_length
 *
 * Return Type: Uint32
 */
...
#if BIND_SDLHapticCustom_length_FIELD_WRITER
/* set_length
 *
 * Parameters:
 * - value: Uint32
...
#if BIND_SDLHapticCustom_delay_FIELD_READER
/* get_delay
 *
 * Return Type: Uint16
 */
...
#if BIND_SDLHapticCustom_delay_FIELD_WRITER
/* set_delay
 *
 * Parameters:
 * - value: Uint16
...
#if BIND_SDLHapticCustom_button_FIELD_READER
/* get_button
 *
 * Return Type: Uint16
 */
...
#if BIND_SDLHapticCustom_button_FIELD_WRITER
/* set_button
 *
 * Parameters:
 * - value: Uint16
...
#if BIND_SDLHapticCustom_interval_FIELD_READER
/* get_interval
 *
 * Return Type: Uint16
 */
...
#if BIND_SDLHapticCustom_interval_FIELD_WRITER
/* set_interval
 *
 * Parameters:
 * - value: Uint16
...
#if BIND_SDLHapticCustom_channels_FIELD_READER
/* get_channels
 *
 * Return Type: Uint8
 */
...
#if BIND_SDLHapticCustom_channels_FIELD_WRITER
/* set_channels
 *
 * Parameters:
 * - value: Uint8
...
#if BIND_SDLHapticCustom_period_FIELD_READER
/* get_period
 *
 * Return Type: Uint16
 */
...
#if BIND_SDLHapticCustom_period_FIELD_WRITER
/* set_period
 *
 * Parameters:
 * - value: Uint16
...
#if BIND_SDLHapticCustom_samples_FIELD_READER
/* get_samples
 *
 * Return Type: Uint16
 */
...
#if BIND_SDLHapticCustom_samples_FIELD_WRITER
/* set_samples
 *
 * Parameters:
 * - value: Uint16
...
#if BIND_SDLHapticCustom_data_FIELD_READER
/* get_data
 *
 * Return Type: Uint16 *
 */
...
#if BIND_SDLHapticCustom_data_FIELD_WRITER
/* set_data
 *
 * Parameters:
 * - value: Uint16 *
...
mrb_SDL_SDLHapticCustom_set_data(mrb_state* mrb, mrb_value self) {
  ...
  Uint16 * native_field = mrb_fixnum_PTR(ruby_field);
...
#if BIND_SDLHapticCustom_attack_length_FIELD_READER
/* get_attack_length
 *
 * Return Type: Uint16
 */
...
#if BIND_SDLHapticCustom_attack_length_FIELD_WRITER
/* set_attack_length
 *
 * Parameters:
 * - value: Uint16
...
#if BIND_SDLHapticCustom_attack_level_FIELD_READER
/* get_attack_level
 *
 * Return Type: Uint16
 */
...
#if BIND_SDLHapticCustom_attack_level_FIELD_WRITER
/* set_attack_level
 *
 * Parameters:
 * - value: Uint16
...
#if BIND_SDLHapticCustom_fade_length_FIELD_READER
/* get_fade_length
 *
 * Return Type: Uint16
 */
...
#if BIND_SDLHapticCustom_fade_length_FIELD_WRITER
/* set_fade_length
 *
 * Parameters:
 * - value: Uint16
...
#if BIND_SDLHapticCustom_fade_level_FIELD_READER
/* get_fade_level
 *
 * Return Type: Uint16
 */
...
#if BIND_SDLHapticCustom_fade_level_FIELD_WRITER
/* set_fade_level
 *
 * Parameters:
 * - value: Uint16
